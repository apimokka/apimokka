...
| M8 — snora 0.28 adoption | Designing | MK-058 design accepted by the project owner 2026-08-04, including four recorded resolutions. Created after snora 0.28.0 shipped two capabilities arising from this programme's own field feedback. Sequenced before M6's L2 live run and L3 sessions so both record the appearance that will ship. Implementation authorization pending. |
