...
pub fn t(key: Key) -> &'static str {
    match key {
        ...
        Key::WizardStarterShopApi  => "Shop API example — explores all features (two rule sets, strategies, fallback files)",
        ...
        Key::DetailErrorExplanation    => "A middleware script threw an error before rule matching ran.",
        ...
        Key::ScriptsEmptyExplanation => "Middleware scripts run before rule matching and can transform requests.",
        ...
        Key::DottedPathJsonpathHint => "Use dotted path syntax, e.g. user.id. JSONPath is not supported.",
        Key::BtnUse                 => "Use",
        ...
        Key::RuleWeightHint              => "Relative likelihood this rule is chosen when WeightedRandom is active. Default: 1.",
        Key::RulePriorityLabel           => "Priority",
        Key::RulePriorityHint            => "Highest priority wins when Priority strategy is active. Negative values allowed.",
        ...
        Key::ModeGuidedDesc    => "Show extra explanations as you work. Best if HTTP mocking is newer to you.",
        Key::ModeExpertTitle   => "Expert",
        Key::ModeExpertDesc    => "Compact view, no extra explanations. Best if you already know your way around.",
        ...
        Key::FallbackEmptyHint        =>
            "Select a file from the sidebar to edit its content.",
