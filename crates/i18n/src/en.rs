...
pub fn t(key: Key) -> &'static str {
    match key {
        ...
        Key::SaveCompletionIndeterminate => "Indeterminate",
        Key::SaveIntegrityFailure => "Workspace integrity failure",
        Key::SaveVerifiedWritten => "Verified written scopes",
        Key::SaveReportedWritten => "Adapter-reported writes; commit status unverified",
        Key::SaveReportedDiffs => "Adapter-reported diffs; commit status unverified",
        Key::SaveReportedFailure => "Adapter-reported failure; failed scope unverified",
        Key::SaveFailedFile => "Failed scope",
        Key::SaveFallbackWritten => "Written fallback scopes",
        Key::SaveRemainingScopes => "Remaining scopes",
        Key::SaveAttemptPhases => "Attempt phases",
        Key::SaveUnsavedPhase => "unsaved",
        Key::SavePendingPhase => "pending",
        Key::SaveNone => "None",
        Key::SavePhaseNone => "none",
        Key::SavePhaseReload => "reload",
        Key::SavePhaseRestart => "restart",
